            ...
            <div class="card-body">
                <form action="/dashboard/kelas/update/{{$kelas->id}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" class="form-control" id="nama" placeholder="Enter Class name" value="{{old('nama', $kelas->nama)}}"> 
                    </div>
                    
                    <button type="submit" class="btn btn-primary mt-5">Update Class</button>
                </form>
            </div>
        </div>
    </div>
