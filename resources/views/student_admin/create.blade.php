            ...
            <div class="card-body">
                <form action="/dashboard/student/add" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nis" class="form-control" id="nis" placeholder="Enter NIS" value="{{old('nis')}}">
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary mt-5">Add Student</button>
                </form>
            </div>
        </div>
    </div>
