...
<table class="table mt-5 table-hover table-bordered caption-top table-responsive table align-middle">
  ...
  <div class="d-flex justify-content-between">
    ...
    <div class="d-flex">
      <form action="/auth/home/student/student">
      ...
      <div class="dropdown ms-4">
        ...
        <ul class="dropdown-menu ms-3">
          <li><a class="dropdown-item" href="/auth/home/student/student">Show All</a></li>
          @foreach ($kelas as $item)
          <li><a class="dropdown-item" href="{{ route('filter_students_home', $item->id) }}">{{ $item->nama }}</a></li>
            @endforeach
        </ul>
      </div>
    </div>
